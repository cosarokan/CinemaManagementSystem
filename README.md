There are nine pages in the project. Home page, movie add page and movie type page, session, saloon, presentation and sell ticket pages. Released movies can change true and false in IsPresentation column. If select end presentation, movie does not show on comboBox in sell ticket page. If select open presentation, movie shows on comboBox in sell ticket page.
